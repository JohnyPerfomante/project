    ...
    <div class="header-bottom">
        <div class="container">
            <ul class="menu-navigation">
                ...
                <!-- <li class="menu-navigation-item">
                    <img class="img-navigation-link" src="/Диплом/images/menu-navigation/drinks.png" alt="drinks">
                    <span style="display: block;"><a class="link-navigation" href="category.php?category=drinks">Напої</a></span>
                </li>
                <li class="menu-navigation-item">
                    <img class="img-navigation-link" src="/Диплом/images/menu-navigation/products.png" alt="products">
                    <span class="line" style="display: block;"><a class="link-navigation" href="category.php?category=products">Продукти</a></span>
                </li> -->
            </ul>
        </div>
    </div>
